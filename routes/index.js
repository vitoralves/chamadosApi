...
router.get('/api/tickets/all/empresa/ticket/:empresa/:usuario/:ticket', db.getTodosTicketsPorId);
router.get('/api/tickets/all/empresa/produto/:empresa/:usuario/:produto', db.getTodosTicketsPorProduto);
router.get('/api/tickets/all/empresa/estado/:empresa/:usuario/:estado', db.getTodosTicketsPorEstado);
